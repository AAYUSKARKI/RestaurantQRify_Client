...
import { mockOrders, mockTables, mockBills, mockMenuItems } from "@/lib/mock-data"
...
export default function DashboardPage() {
  ...
  const stats = [
    ...
    },
    {
      ...
      value: `${occupiedTables}/${mockTables.length}`,
    ...
    {
      title: "Menu Items",
      value: mockMenuItems.length.toString(),
      description: `${mockMenuItems.filter((m) => m.isAvailable).length} available`,
      icon: TrendingUp,
      color: "text-chart-4",
    },
  ]
