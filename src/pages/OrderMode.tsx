...
export default function OrderMode({ tableId, onBack }: OrderModeProps) {
  ...
  return (
    <div className={`h-screen flex overflow-hidden dark:bg-slate-950 bg-gradient-to-br from-slate-50 via-white to-amber-50/30`}>
      {/* LEFT SIDE: Menu Browser */}
      <div className="flex-1 flex flex-col min-w-0 dark:bg-slate-900">
        {/* Fixed Header */}
        <div className="flex-shrink-0 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 shadow-sm backdrop-blur-xl bg-white/95 dark:bg-slate-900/95 z-10">
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-3">
                ...
                <Button
                  ...
                  onClick={() => {
                    // TODO: Implement actual order placement logic (e.g., dispatch to Redux, API call)
